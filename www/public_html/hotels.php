                            ...
                            <div class="menu-bar">  
                                ...
                                <nav id="primary-navigation">            
                                    <ul class="primary-navbar">  
                                        ...
                                        <li class="active"><a href="hotels.php" class="active">Hotels</a></li>
                ...
                <section class="listing-wrap pt-50">
                    <div class="container">
                        <div class="clearfix">
                            <div class="col-md-3 col-sm-4 pt-50 no-padding listing-sidebar">
                                ...
                                <div class="theme-color-bg">
                                    <div class="widget-nav">
                                        <h3 class="title">ZONES</h3>
                                        <ul class="list">
                                            <li> <a href="#"> Punta Cana </a> </li>
                                            <li> <a href="#"> Bayahibe  </a> </li>
                                            <li> <a href="#"> Ubero Alto </a> </li>
                                            <li> <a href="#"> Cabeza del Toro </a> </li>
                                            <li> <a href="#"> Bavaro </a> </li>
                            ...
                            <div class="col-md-9 col-sm-8 pt-50 style-one no-padding" id="gridOfHotelsOrTours">
                                <!--
