    ...
    <body id="home" class="wide">
        ...
        <main class="wrapper"> 
            ...
            <article class="home-three">
                ...
                <div class="main-banner-1">
                    <div class="item">
                        <div class="info container">
                            <h2 class="font-2"> Have fun and Travel </h2>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="search-1">                                   
                                    <form role="form" class="search-form" method="post">                                                                                   
                                        ...
                                        <div class="form-group width-10">
                                            <div class="search-selectpicker selectpicker-wrapper">
                                                <select class="selectpicker form-control border" required="" data-width="100%" data-toggle="tooltip">
                                        ...
                                        <div class="form-group width-10">
                                            <div class="search-selectpicker selectpicker-wrapper">
                                                <select class="selectpicker form-control" required="" data-width="100%" data-toggle="tooltip">
                ...
                <section class="sec-space travellers-choice light-bg">
                    <div class="container">
                        <div class="title-wrap-2 text-center">
                            <h2 class="section-title">Hotels by zone in Dominican Republic</h2>
                            <p> The Very Best of Travel, Chosen by Millions of Travelers </p>
                        </div>
                        <div class="row">  
                            <div class="three-column meso-section clearfix">                           
                                <div class="grid-sizer"></div>
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x470-1.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>370<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> PUNTA CANA </a> </h2> 
                                            <!-- <span class="fsz-13">DR</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                                ...
                                                <p>Lorem ipsum dolor sit amet consectuerer delgado adipiscing diam dolorado the best place.</p>                                             
                                            </div>
                                        </div>
                                        <a href="#" class="title-1 rotated-text"> <span> SHARE THIS PLACE </span> </a>
                                    </div>                                    
                                </div>
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x270-1.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>225<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> UVERO ALTO </a> </h2> 
                                            <!-- <span class="fsz-13">Sydney Australia</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                                <div class="price">                                                    
                                ...
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x370-1.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>217<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> BAYAHIBE </a> </h2> 
                                            <!-- <span class="fsz-13">British Columbia</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                                <div class="price">                                                    
                                ...
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x370-2.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>180<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> LA ROMANA </a> </h2> 
                                            <!-- <span class="fsz-13">Philadelphia</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                                <div class="price">                                                    
                                ...
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x470-2.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>425<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> SAMANA </a> </h2> 
                                            <!-- <span class="fsz-13">Sydney Australia</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                ...
                                <div class="meso-wrap white-color">
                                    <div class="feature-2 flex-item">
                                        <img src="assets/images/gallery/370x370-3.jpg" alt="">
                                        <div class="price-2">
                                            <span class="fsz-40 theme-color fw-300"> <small>$</small>200<small>.00</small> </span>
                                            <h2 class="title-3 no-margin"> <a href=""> BAVARO </a> </h2>
                                            <!-- <span class="fsz-13">Netherland</span> -->
                                        </div>
                                        <div class="flex-wrap">
                                            <div class="flex-caption middle info transition">                                                
                                                <div class="price">                                                    
                ...
                <section class="sec-space agency">
                    <div class="container">
                        <div class="title-wrap-2 text-center">
                            <h2 class="section-title"> Domyfun International. </h2>
                ...
                <section class="sec-space ideal-trip">
                    <div class="container">
                        <div class="title-wrap-2 wave-line-2 text-center">
                            <img alt="" src="assets/images/icons/logo-icon.png" width="200"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 pb-50">
                                <div class="info">
                                    ...
                                    <h2 class="title-2 white-color pt-10">450+ <span class="fsz-18"> Transfers </span> </h2>
                                    <p>The lorem dolarado sit amet cheap flight up to 2.340 locations</p>
                                </div>
                                <a href="#" class="all-show white-color">View all our transfers</a>
                            </div>
                            <div class="col-md-3 col-sm-6 pb-50">
                                <div class="info">
                ...
                <!-- Travel Video Start -->
                <section class="travel-video rel-div">
                    <div class="video-link">
                        <a class="popup-youtube btn-play fa fa-caret-right theme-color-bg" href="https://www.youtube.com/watch?v=F-uPHbfznlM"> </a>
                        <h2 class="title-2 white-color pt-30">Play Video</h2>
                    </div>
                </section>
                <!-- / Travel Video Ends -->  
            ...
            <footer class="page-footer">             
                ...
                <div class="text-center">
                    ...
                    <div class="container copyright">
                        <p> <a href="index.html" class="theme-color fw-500">Domyfun</a> ©2022 Made with <i class="fa fa-heart red-clr"></i> All Right Reserved </p>
                    </div>
                </div>
                <!-- / Footer Menu Ends -->  
